...
_NSE500: list[dict] = [
    ...
    {"ticker": "NIITMTS.NS",      "name": "NIIT Learning Systems",             "sector": "Technology"},
    ...
    {"ticker": "ZENSARTECH.NS",   "name": "Zensar Technologies",               "sector": "Technology"},
    {"ticker": "SONATSOFTW.NS",   "name": "Sonata Software",                   "sector": "Technology"},
    {"ticker": "RAMCOSYS.NS",     "name": "Ramco Systems",                     "sector": "Technology"},
    ...
    {"ticker": "BSOFT.NS",        "name": "Birlasoft Ltd",                     "sector": "Technology"},
    ...
    {"ticker": "TMB.NS",          "name": "Tamilnad Mercantile Bank",          "sector": "Banking & Finance"},
    ...
    {"ticker": "NAM-INDIA.NS",    "name": "Nippon India Asset Management",     "sector": "Banking & Finance"},
    ...
    {"ticker": "PEL.NS",          "name": "Piramal Enterprises",               "sector": "Banking & Finance"},
    ...
    {"ticker": "NIFTYBEES.NS",    "name": "Nippon India Nifty 50 BeES ETF",   "sector": "Banking & Finance"},
    ...
    {"ticker": "UNITDSPR.NS",     "name": "United Spirits (Diageo)",           "sector": "FMCG"},
    ...
    {"ticker": "JBCHEPHARM.NS",   "name": "JB Chemicals & Pharmaceuticals",    "sector": "Healthcare"},
    ...
    {"ticker": "ASTERDM.NS",      "name": "Aster DM Healthcare",               "sector": "Healthcare"},
    ...
    # Remove DIVI.NS duplicate — DIVISLAB.NS already defined above
    ...
    {"ticker": "STAR.NS",         "name": "Strides Pharma Science",            "sector": "Healthcare"},
    ...
    {"ticker": "KALPATARU.NS",    "name": "Kalpataru Projects International",  "sector": "Infrastructure"},
    ...
    {"ticker": "AMARARAJA.NS",    "name": "Amara Raja Energy & Mobility",      "sector": "Automobile"},
    ...
    {"ticker": "UNOMINDA.NS",     "name": "UNO Minda Ltd",                     "sector": "Automobile"},
    {"ticker": "SUPRAJIT.NS",     "name": "Suprajit Engineering",              "sector": "Automobile"},
    {"ticker": "ATUL.NS",         "name": "Atul Auto Ltd",                     "sector": "Automobile"},
    {"ticker": "OLECTRA.NS",      "name": "Olectra Greentech (Electric Buses)", "sector": "Automobile"},
    ...
    {"ticker": "WELSPUNLIV.NS",   "name": "Welspun Living",                    "sector": "Metals & Mining"},
    {"ticker": "SHYAMMETL.NS",    "name": "Shyam Metalics and Energy",         "sector": "Metals & Mining"},
    ...
    {"ticker": "LEMONTREE.NS",    "name": "Lemon Tree Hotels",                 "sector": "Consumer Discretionary"},
    ...
    {"ticker": "PVRINOX.NS",      "name": "PVR INOX Ltd",                      "sector": "Consumer Discretionary"},
    ...
    {"ticker": "LIBERTSHOE.NS",   "name": "Liberty Shoes",                     "sector": "Consumer Discretionary"},
    ...
    {"ticker": "AWL.NS",          "name": "Adani Wilmar Ltd",                  "sector": "Conglomerates"},
    {"ticker": "TATACHEM.NS",     "name": "Tata Chemicals",                    "sector": "Conglomerates"},
    {"ticker": "GRASIM.NS",       "name": "Grasim Industries",                 "sector": "Conglomerates"},
    {"ticker": "ABCAPITAL.NS",    "name": "Aditya Birla Capital",              "sector": "Conglomerates"},
    ...
    {"ticker": "MAHSCOOTER.NS",   "name": "Maharashtra Scooters",              "sector": "Conglomerates"},
    {"ticker": "3MINDIA.NS",      "name": "3M India",                          "sector": "Conglomerates"},
    {"ticker": "HONAUT.NS",       "name": "Honeywell Automation India",        "sector": "Conglomerates"},
